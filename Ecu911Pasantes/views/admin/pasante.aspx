            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-3 col-form-label">Nombres</label>
                                <div class="col-sm-12 col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <asp:TextBox ID="txtArea" type="text" CssClass="form-control" placeholder="Ingrese el area designada" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ForeColor="Red" runat="server" ErrorMessage="La area designada es requerida" ControlToValidate="txtArea" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtUniversidad" type="text" CssClass="form-control" placeholder="Ingrese la universidad" runat="server"></asp:TextBox>
                        ...
                        <div class="col-4">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-3 col-form-label">Carrera</label>
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtCarrera" type="text" CssClass="form-control" placeholder="Ingrese la carrera" runat="server"></asp:TextBox>
                        ...
                        <div class="col-4">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Nivel</label>
                                <div class="col-sm-12 col-md-10">
                                    <asp:TextBox ID="txtNivel" TextMode="Number" CssClass="form-control" placeholder="Ingrese el nivel de semestre" runat="server"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-3 col-form-label">Actividad</label>
                                <div class="col-sm-12 col-md-9">
                        ...
                        <div class="col-4">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-3 col-form-label">Asistencia</label>
                                <div class="col-sm-12 col-md-9">
                                    <asp:TextBox ID="txtCodPa" CssClass="form-control" placeholder="Ingrese el codigo de asistencia" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" ForeColor="Red" runat="server" ErrorMessage="El codigo de asistencia es requerido" ControlToValidate="txtCodPa" ValidationGroup="Info" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <asp:Button ID="btnCodPa" CssClass="btn btn-success" OnClick="btnCodPa_Click" runat="server" Text="Generar codigo" />
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">ECU</label>
                                <div class="col-sm-12 col-md-10">
                                    <asp:TextBox ID="txtCodEcu" CssClass="multisteps-form__input form-control" placeholder="Ingrese el codigo del ECU" runat="server"></asp:TextBox>
